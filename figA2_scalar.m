...
% ==== DEFINE OUTPUTS ====
outputs = { ...   
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_gradualRT_25km',...
    ...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_gradualRT_50km',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_gradualRT_50km_ocndT_1e-1',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_gradualRT_50km_ocndT_2e-1',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_gradualRT_50km_ocndT_5e-1',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_gradualRT_50km_ocndT_1e1',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_gradualRT_50km_ocndT_2e1',...
};
legend_name = { ...
    'RT',...
    'OC 0.1 + RT',...
...
% limits for plot
xmin=2000; xmax=2500;
ymin=0; ymax=30; % 350 it was before
...
text(1.1,0.7,'RT25','FontSize',10)
text(1.1,0.3,'RT50','FontSize',10)

axis off

%==========================================
print(H.fig,'/Users/frre9931/Documents/PhD/ANT_UFEMISM/plots_ant/Riiser-Larsen/multipanel/scalarSLE_Hbcapped_OC+RT.pdf','-dpdf','-vector');