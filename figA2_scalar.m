...
outputs = { ...   
    ...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_gradualRT_25km_ocndT_2e1_N',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_gradualRT_50km_N',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_gradualRT_50km_ocndT_1e-1_N',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_gradualRT_50km_ocndT_2e-1_N',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_gradualRT_50km_ocndT_5e-1_N',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_gradualRT_50km_ocndT_1e1_N',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_gradualRT_50km_ocndT_2e1_N',...
};
legend_name = { ...
    'RT',...
    'OC 0.1 + RT',...
...
% limits for plot
xmin=2000; xmax=2500;
ymin=0; ymax=40; % 30 it was before
