...
% ==== DEFINE OUTPUTS ====
outputs = { ...   
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_retreat_N',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_retreat_ocndT_1e-1_N',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_retreat_ocndT_2e-1_N',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_retreat_ocndT_5e-1_N',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_retreat_ocndT_1e1_N',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_retreat_ocndT_2e1_N',...
    'results_ant_PD_maxphi_30_SHR_retreat_N',...
    'results_ant_PD_maxphi_30_SHR_retreat_ocndT_1e-1_N',...
    'results_ant_PD_maxphi_30_SHR_retreat_ocndT_2e-1_N',...
    'results_ant_PD_maxphi_30_SHR_retreat_ocndT_5e-1_N',...
    'results_ant_PD_maxphi_30_SHR_retreat_ocndT_1e1_N',...
    'results_ant_PD_maxphi_30_SHR_retreat_ocndT_2e1_N',...
};
legend_name = { ...
    'NS',...
    'OC 0.1 + NS',...
...
% limits for plot
xmin=2000; xmax=2500;
ymin=0; ymax=80; % 110 it was before
...
for i=1:length(outputs)
    ...
    if i > length(plots_with_same_style)
        ...
        path_ctrl = fullfile(basepath,folder_ctrl{1},'/scalar_output_ANT_00001.nc');
        ice_volume_af_ctrl=ncread(path_ctrl,'ice_volume_af');
        time_ctrl = ncread(path_ctrl,'time');
    end

    % interp to ctrl values
    ice_volume_af_interp = interp1(time,ice_volume_af,time_ctrl);
...
%==========================================
print(H.fig,'/Users/frre9931/Documents/PhD/ANT_UFEMISM/plots_ant/Riiser-Larsen/multipanel/scalarSLE_standard_vs_Hbcapped_CTRL_FIX.pdf','-dpdf','-vector');