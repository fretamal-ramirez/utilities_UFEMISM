...
outputs = { ...
    ...
    %'results_ant_PD_maxphi_Hb-2000to-250m_SHR_ctrl2500_ocndT_rt_8e-3_max_1e1'...
};
titles_name = { ...
    'max ϕ = 30', ...
    'Hb capped ϕ',...
...
present_day = 'results_ant_PD_inversion_dHdt_init_R-LIS_gamma99_PMP_roughness_max30_SHR_new'; %'results_ant_PD_inversion_dHdt_init_R-LIS_gamma20_PMP';
...
plot_titles = {'Velocity (m/yr)', 'Till friction (°)', 'ΔIce thickness (m)'};
%plot_titles = {'Velocity (m/yr)', 'Basal melt rate (m/yr)', 'ΔIce thickness (m)', 'ΔBedrock elevation (m)'};
...
for r = 1:nRows
    ...
    switch r
        ...
        case 2
            ...
            cb.Label.String = 'Till friction (°)';
        case 3
            cb.Label.String = 'ΔHi (m)';
        % case 4
        %     cb.Label.String = 'ΔHb (m)';
    end
end
