...
% ==== DEFINE OUTPUTS ====
outputs = { ...   
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_ctrl2500_ocndT_1e-1',...
    'results_ant_PD_maxphi_Hb-2000to-250m_SHR_ctrl2500_ocndT_2e-1',...
...
%==========================================
print(H.fig,'/Users/frre9931/Documents/PhD/ANT_UFEMISM/plots_ant/Riiser-Larsen/multipanel/scalarSLE_standalone_forcings_Hbcapped_CTRL.pdf','-dpdf','-vector');